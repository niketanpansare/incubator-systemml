...
class Keras2DML(Caffe2DML):
    ...
    def __init__(self, sparkSession, keras_model, input_shape=None, transferUsingDF=False, load_keras_weights=True, weights=None, labels=None,
        ...
        if keras.backend.image_data_format() != 'channels_first':
            raise Exception('Keras2DML only supports channels_first format, but found ' + str(
                K.image_data_format()) + '. Hint: Use keras.backend.set_image_data_format("channels_first")')
