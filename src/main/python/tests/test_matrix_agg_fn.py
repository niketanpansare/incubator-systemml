...
#   - Python 2: `PYSPARK_PYTHON=python2 spark-submit --master local[*] --driver-class-path ../../../../target/SystemML.jar test_matrix_agg_fn.py`
#   - Python 3: `PYSPARK_PYTHON=python3 spark-submit --master local[*] --driver-class-path ../../../../target/SystemML.jar test_matrix_agg_fn.py`
