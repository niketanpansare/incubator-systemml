...
public class ReLULayer extends Layer {
	...
	public ReLULayer(LayerParameter param) throws DMLRuntimeException {
		super(param, "H_");
	...
	public void generateForwardDML(TabbedStringBuilder dmlScript) throws DMLRuntimeException {
		...
		dmlScript.append(assign(getTopDMLVar(), max("0", getBottomDMLVar())));
	}
	...
	public void generateBackwardDML(TabbedStringBuilder dmlScript) throws DMLRuntimeException {
		...
		assertBottom(1);
		dmlScript.append(assign(getBottomLayerDeltaVar(), mult(gt(getBottomDMLVar(), "0", true), deltaVar)));
	}
