...
with open('time.txt', 'a') as f:
	f.write(config['framework'] + ',' + config['model'] + ',' + config['data'] + ',' + str(config['epochs']) + ',' + str(config['batch_size']) + ',' + str(config['num_gpus']) + ',' + str(end-start) + ',' + str(data_loading) + ',' + str(model_loading) + ',' + str(end-t2) + '\n')
